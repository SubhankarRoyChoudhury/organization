...
export default function Home() {
  ...
  const [isLoadingHospitalReferenceOptions, setIsLoadingHospitalReferenceOptions] =
    useState(false);
    ...
    try {
      ...
      setHospitalReferenceOptions({
        ...
        administrationTypes: Array.isArray(administrationTypes)
          ? administrationTypes
          : [],
        staffDepartments: Array.isArray(staffDepartments) ? staffDepartments : [],
  ...
  const handleOrganizationUserCreateFieldValueChange = (name, value) => {
    setOrganizationUserCreateForm((prev) => {
      ...
      if (name === "staff_department" && String(prev.staff_department) !== String(value || "")) {
        return {
          ...prev,
  ...
  const handleOrganizationUserCreateSubmit = async (event) => {
    ...
    if (!payload.name || !payload.username || !payload.email || !payload.phone_number) {
      setOrganizationUserCreateError(
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-b from-[#e1f5ff] via-white to-[#d7f1ff] px-6 py-10">
      <svg
      ...
      <div className="relative mx-auto flex w-full max-w-6xl flex-col gap-10">
        <header className="flex flex-wrap items-center justify-between gap-6">
          <div className="space-y-2">
            ...
            <p className="max-w-2xl text-base text-gray-600">
              A modern control center for hospital operations, payroll, assets,
              and finances.
            </p>
          </div>
            ...
            <div className="relative">
              ...
              {isProfileMenuOpen && (
                <div className="absolute right-0 z-50 mt-3 w-64 rounded-2xl border border-blue-100 bg-white p-3 text-sm text-gray-700 shadow-xl">
                  ...
                  {(profileData.isAdminOwner || isSuperuserSession) && (
                    <button
                      type="button"
                      onClick={() => {
                        setActiveSection("hospital");
                  ...
                  <button
                    ...
                    onClick={() => {
                      resetOrganizationUserCreateForm();
                      setOrganizationUserCreateDialogOpen(true);
                      setProfileMenuOpen(false);
                  ...
                  <button
                    ...
                    onClick={() => {
                      resetSchoolCreateForm();
                      setSchoolCreateDialogOpen(true);
                      setProfileMenuOpen(false);
                    }}
                    className="mt-2 w-full rounded-xl px-3 py-2 text-left font-semibold text-gray-700 transition hover:bg-blue-50"
                  >
        ...
        <section className="grid gap-6 md:grid-cols-2">
          {availableModules.map((module) => {
            ...
            const cardClassName = `group relative overflow-hidden rounded-[28px] border border-white/80 bg-white/80 p-7 shadow-lg transition ${module.enabled ? "hover:-translate-y-1 hover:shadow-xl" : "opacity-40 grayscale"} ${module.ring}`;
            const cardContent = (
              <>
                <div
                  className={`absolute inset-0 opacity-0 transition duration-500 group-hover:opacity-100 bg-gradient-to-br ${module.tint}`}
                />
                ...
                <div className="relative mt-6 h-1 w-12 rounded-full bg-blue-500/30 transition group-hover:w-20 group-hover:bg-blue-500/60" />
              </>
            );
      ...
      >
        ...
        >
          <DialogHeader>
            ...
            <DialogDescription className="text-sm text-gray-600">
              Admins must finish the hospital details before continuing.
            </DialogDescription>
          </DialogHeader>
          ...
          <form onSubmit={handleCompanyInfoSubmit} className="space-y-6">
                  ...
                  <div className="flex flex-col items-center gap-4 rounded-xl border border-gray-100 bg-slate-50/60 px-4 py-6 text-center">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        Upload a square image to represent your hospital.
                      </p>
                    </div>
            ...
            <div className="space-y-4">
              ...
              >
                Owners
                <span className="text-xs text-blue-700">
                  {activeSection === "owners" ? "Hide" : "Show"}
                </span>
              </button>
              {activeSection === "owners" && (
                <div className="space-y-4 rounded-2xl border border-blue-100 bg-white p-4">
                  <div className="flex flex-wrap items-center justify-between gap-3">
                    <p className="text-sm text-gray-600">
                      Add the owners linked with this hospital.
                    </p>
                    <button
                      type="button"
                      onClick={() => {
                  ...
                  {editedOwners.length === 0 ? (
                    ...
                    <div className="space-y-3">
                      <div className="grid gap-3 text-xs font-semibold uppercase tracking-wide text-gray-500 sm:grid-cols-[1.6fr_1.6fr_2fr_1.4fr_2fr_1.2fr_1fr_auto]">
                        <span>Name</span>
                      ...
                      {editedOwners.map((owner) => (
                        <div
                          key={owner.id}
                          className="grid items-center gap-3 rounded-xl border border-gray-200 bg-gray-50/70 p-3 sm:grid-cols-[1.6fr_1.6fr_2fr_1.4fr_2fr_1.2fr_1fr_auto]"
                        >
                          ...
                          {editingOwnerId === owner.id ? (
                            <label className="flex items-center gap-2 text-sm text-gray-700">
                              <input
                                type="checkbox"
                                checked={Boolean(owner.primary_admin)}
                                onChange={(event) =>
                                  handleOwnerFieldChange(
                                    owner.id,
                                    "primary_admin",
                          ...
                          {editingOwnerId === owner.id ? (
                            <div className="flex items-center gap-2">
                              <button
                                ...
                                title="Save"
                                className="rounded-lg bg-blue-600 p-2 text-white shadow-sm transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-70"
                              >
                                <Check className="h-4 w-4" />
                              </button>
                              <button
                                type="button"
                                onClick={() => handleOwnerCancel(owner.id)}
                                title="Cancel"
                            ...
                            <div className="relative">
                              ...
                              {ownerMenuOpenId === owner.id && (
                                <div className="absolute right-0 z-20 mt-2 w-36 rounded-xl border border-gray-200 bg-white py-1 text-xs font-medium text-gray-700 shadow-lg">
                                  <button
                                    type="button"
                                    onClick={() => {
                                      handleOwnerEdit(owner.id);
                                      setOwnerMenuOpenId(null);
                                    }}
                                  ...
                                  <button
                                    type="button"
                                    onClick={() => {
                                      handleCreateUserForOwner(owner);
                                      setOwnerMenuOpenId(null);
                                    }}
                                    disabled={Boolean(
                                      ownerAccountStatus[owner.id],
                                    )}
                                    title={
                                      ownerAccountStatus[owner.id]
                                        ? "User already exists"
                                    ...
                                    className="w-full px-3 py-2 text-left transition hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-60"
                                  >
                                    Create user
                                  </button>
                                </div>
            ...
            <div className="space-y-4">
              ...
              >
                Statutory register
                <span className="text-xs text-blue-700">
                  {activeSection === "statutory" ? "Hide" : "Show"}
                </span>
              </button>
              {activeSection === "statutory" && (
                <div className="space-y-4 rounded-2xl border border-blue-100 bg-white p-4">
                  <div className="flex flex-wrap items-center justify-between gap-3">
                    <p className="text-sm text-gray-600">
                      Add statutory register records for this hospital.
                    </p>
                    <div className="flex items-center gap-2">
                      {/* <button
                        type="button"
                        ...
                        className="rounded-xl border border-blue-200 px-4 py-2 text-xs font-semibold text-blue-700 transition hover:bg-blue-50"
                      >
                        Add custom field
                      </button> */}
                      <button
                  ...
                  {editedStatutoryRegisters.length === 0 ? (
                    <p className="text-sm text-gray-500">
                      No statutory register records added yet.
                    </p>
                  ) : (
                    <div className="space-y-3">
                      {(() => {
                        const customCount = statutoryCustomFields.length;
                        const customCols =
                          customCount > 0
                            ? `repeat(${customCount}, 1.5fr) `
                            : "";
                        const gridTemplate = `0.6fr 1.6fr 1.2fr 1fr 1fr 1fr 1.5fr ${customCols}auto`;
                        return (
                          <div
                            className="grid gap-3 text-xs font-semibold uppercase tracking-wide text-gray-500"
                      ...
                      {editedStatutoryRegisters.map((item, index) => (
                        <div
                          key={item.id}
                          className="grid items-start gap-3 rounded-xl border border-gray-200 bg-gray-50/70 p-3"
                          style={{
                            gridTemplateColumns: `0.6fr 1.6fr 1.2fr 1fr 1fr 1fr 1.5fr ${
                              statutoryCustomFields.length > 0
                                ? `repeat(${statutoryCustomFields.length}, 1.5fr) `
                                : ""
                            }auto`,
                          }}
                        >
                          ...
                          {editingStatutoryId === item.id ? (
                            <input
                              type="text"
                              value={item.desc || ""}
                              onChange={(event) =>
                                handleStatutoryFieldChange(
                                  item.id,
                                  "desc",
                                  event.target.value,
                                )
                          ...
                          {editingStatutoryId === item.id ? (
                            ...
                            >
                              {statutoryFields
                                .find((field) => field.key === "renewed_type")
                                ?.options.map((option) => (
                          ...
                          {editingStatutoryId === item.id ? (
                            <input
                              ...
                              value={
                                item.renewal_date
                                  ? String(item.renewal_date).slice(0, 10)
                                  : ""
                              }
                              onChange={(event) =>
                                handleStatutoryFieldChange(
                          ...
                          {statutoryCustomFields.map((field) =>
                            editingStatutoryId === item.id ? (
                              <input
                                ...
                                value={item.custom_values?.[field.id] || ""}
                                onChange={(event) =>
                                  handleStatutoryCustomValueChange(
                                    item.id,
                                    field.id,
                                    event.target.value,
                                  )
                          ...
                          {editingStatutoryId === item.id ? (
                            <div className="flex items-center gap-2">
                              <button
                                type="button"
                                onClick={() => handleStatutorySave(item.id)}
                              ...
                              <button
                                type="button"
                                onClick={() => handleStatutoryCancel(item.id)}
                                title="Cancel"
                                className="rounded-lg border border-gray-200 p-2 text-gray-700 transition hover:bg-gray-50"
                              >
                                <X className="h-4 w-4" />
                            ...
                            <button
                              type="button"
                              onClick={() => handleStatutoryEdit(item.id)}
                              title="Edit"
                              className="rounded-lg border border-gray-200 p-2 text-gray-700 transition hover:bg-gray-50"
                            >
      ...
      <ImageCropDialog
        key={imageCropDialog.sourceUrl || "image-crop-home"}
