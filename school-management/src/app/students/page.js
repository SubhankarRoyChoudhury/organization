          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="hidden items-center gap-3 lg:flex">
              ...
              <button
                ...
                aria-label="Watch student setup video"
                title="Watch student setup video"
              >
                <svg
                  viewBox="0 0 24 24"
                  className="h-5 w-5"
          ...
          <div className="w-full max-w-4xl overflow-hidden rounded-2xl bg-white shadow-2xl">
            ...
            <div className="aspect-video w-full bg-black">
              <iframe
                ...
                src="https://www.youtube-nocookie.com/embed/VFbvjbN4dyc?autoplay=1&vq=hd1080&rel=0&modestbranding=1&iv_load_policy=3&playsinline=1"
                title="Student setup tutorial video"
